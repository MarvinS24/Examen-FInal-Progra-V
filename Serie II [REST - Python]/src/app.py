...
def listar_cursos():
    try:
        ...
        for fila in datos:
            ...
            cursos.append(curso)
        return jsonify({'cursos': cursos, 'mensaje': "Tareas listadas.", 'exito': True})
...
def leer_curso(codigo):
    try:
        ...
        if datos != None:
            ...
            return jsonify({'curso': curso, 'mensaje': "tareas encontradas.", 'exito': True})
        else:
...
def registrar_cursos():
    try:
        ...
        return jsonify({'mensaje': "Tarea resgistrada.", 'exito': True})
    except Exception as ex:
        return jsonify({'mensaje': "Error", 'exito': False})
...
def actualizar_curso(codigo):
    try:
        ...
        cursor.execute(sql)
        conexion.connection.commit()  # Confirma la acción de inserción.
        return jsonify({'mensaje': "Tarea actualizada.", 'exito': True})
    except Exception as ex:
        return jsonify({'mensaje': "Error", 'exito': False})
...
def eliminar_curso(codigo):
    try:
        ...
        cursor.execute(sql)
        conexion.connection.commit()  # Confirma la acción de inserción.
        return jsonify({'mensaje': "Tarea eliminada.", 'exito': True})
    except Exception as ex:
        return jsonify({'mensaje': "Error", 'exito': False})
